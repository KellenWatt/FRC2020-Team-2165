...
ArmSubsystem::ArmSubsystem() : ArmSubsystem::ArmSubsystem(0,0,0,0,0) {}

ArmSubsystem::ArmSubsystem(int motor, int up, int down) : ArmSubsystem::ArmSubsystem(motor, up, down, 0, 0) {}
